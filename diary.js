...
function messageSkeleton(){
  return '<div role="status"><span class="loading-sr-only">Wczytywanie wiadomości…</span><div class="page-skeleton" data-skeleton="wiadomosci" aria-hidden="true"><div class="message-card sk-message"><div class="sk-between"><span class="skeleton-block sk-bar sk-small" style="width:30%"></span><span class="skeleton-block sk-bar sk-small" style="width:22%"></span></div><span class="skeleton-block sk-bar sk-heading" style="width:60%"></span><span class="skeleton-block sk-bar " style="width:100%"></span><span class="skeleton-block sk-bar " style="width:80%"></span></div><div class="message-card sk-message"><div class="sk-between"><span class="skeleton-block sk-bar sk-small" style="width:30%"></span><span class="skeleton-block sk-bar sk-small" style="width:22%"></span></div><span class="skeleton-block sk-bar sk-heading" style="width:60%"></span><span class="skeleton-block sk-bar " style="width:100%"></span><span class="skeleton-block sk-bar " style="width:80%"></span></div><div class="message-card sk-message"><div class="sk-between"><span class="skeleton-block sk-bar sk-small" style="width:30%"></span><span class="skeleton-block sk-bar sk-small" style="width:22%"></span></div><span class="skeleton-block sk-bar sk-heading" style="width:60%"></span><span class="skeleton-block sk-bar " style="width:100%"></span><span class="skeleton-block sk-bar " style="width:80%"></span></div></div></div>';
}
let lessonPlanData=[];
let attendanceData=[];
